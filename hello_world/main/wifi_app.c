...
esp_netif_t* esp_netif_sta = 0;
esp_netif_t* esp_netif_ap  = 0;
	...
	for (;;)
	{
		if (xQueueReceive(wifi_app_queue_handle, &msg, portMAX_DELAY))
		{
			...
			case WIFI_APP_MSG_START_HTTP_SERVER:
				...
				break;
			case WIFI_APP_MSG_CONNECTING_FROM_HTTP_SEVER:
							ESP_LOGI(TAG, "WIFI_APP_MSG_CONNECTING_FROM_HTTP_SEVER");

							break;
			case WIFI_APP_MSG_STA_CONNECTING_GOT_IP:
							ESP_LOGI(TAG, "WIFI_APP_MSG_STA_CONNECTING_GOT_IP");
...
//	rgb_led_wifi_app_started();
	...
	// Create message queue
		...
		// Start the WiFi application task
			xTaskCreatePinnedToCore(&wifi_app_task, "wifi_app_task", WIFI_APP_TASK_STACK_SIZE, 0, WIFI_APP_TASK_PRIORITY, 0, WIFI_APP_TASK_CORE_ID);
}
